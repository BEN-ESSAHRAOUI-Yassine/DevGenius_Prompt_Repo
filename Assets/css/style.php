...
.p-welcome .username {
    color: rgb(6, 6, 72);   /* Color for the username */
    font-weight: bold; /* Optional: make it bold */
}

.p-welcome .role {
    color: rgb(40, 151, 241);  /* Color for the role */
...
.status-deployed { background: #3498db; }
...
/* Dynamic category colors (generate class with PHP) */
<?php
$colors = ['#1abc9c','#9b59b6','#e67e22','#e74c3c','#3498db','#f1c40f','#2ecc71','#34495e','#d35400','#7f8c8d'];
...
.summary-item:nth-child(1) { border-left-color: #2ecc71; } /* green */
.summary-item:nth-child(2) { border-left-color: #f39c12; } /* orange */
.summary-item:nth-child(3) { border-left-color: #9b59b6; } /* purple */
